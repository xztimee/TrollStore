...
@implementation LSApplicationsManager

+ (instancetype)sharedInstance
{
    static LSApplicationsManager *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[LSApplicationsManager alloc] init];
    });
...
{
    return luiseStoreInstalledAppBundlePaths();
}
...
- (int)installIpa:(NSString*)pathToIpa force:(BOOL)force log:(NSString**)logOut
{
    ...
    NSNumber* installationMethodToUseNum = [luiseStoreUserDefaults() objectForKey:@"installationMethod"];
