...
+ (void)startActivity:(NSString*)activity withCancelHandler:(void (^)(void))cancelHandler
{
	...
	else
	{
		...
		UILayoutGuide *safeArea = activityController.view.safeAreaLayoutGuide;
		...
		[NSLayoutConstraint activateConstraints:@[
			...
			[activityIndicator.centerXAnchor constraintEqualToAnchor:card.contentView.centerXAnchor],
			[activityIndicator.topAnchor constraintEqualToAnchor:card.contentView.topAnchor constant:18.0],
			[titleLabel.leadingAnchor constraintEqualToAnchor:card.contentView.leadingAnchor constant:20.0],
			[titleLabel.trailingAnchor constraintEqualToAnchor:card.contentView.trailingAnchor constant:-20.0],
			[titleLabel.topAnchor constraintEqualToAnchor:activityIndicator.bottomAnchor constant:10.0],
			[titleLabel.bottomAnchor constraintEqualToAnchor:card.contentView.bottomAnchor constant:-18.0]
		]];
		...
		if(cancelHandler)
		{
			...
			[NSLayoutConstraint activateConstraints:@[
				[cancelButton.centerXAnchor constraintEqualToAnchor:safeArea.centerXAnchor],
				...
				[cancelButton.widthAnchor constraintGreaterThanOrEqualToConstant:88.0],
				[cancelButton.bottomAnchor constraintLessThanOrEqualToAnchor:safeArea.bottomAnchor constant:-16.0]
			]];
		}
